package com.kevin.parkme.utils.pdf;
...
import com.kevin.parkme.BuildConfig;
...
public class InvoiceGenerator {
    ...
    public void create(){
        ...
        canvas.drawText("ParkMe",30,60,paint);
...
//        canvas.drawText("",550,615,paint);
    ...
    public void downloadFile(String userID, String bookingKey, Context context, Application application) {
        if(utils.isNetworkAvailable(application)){
            ...
            final File localFile = new File(Environment.getExternalStorageDirectory()+"/Download", "invoice.pdf");
    ...
    public void openFile(Context context) {
        ...
        Uri data = FileProvider.getUriForFile(context,context.getApplicationContext().getPackageName()  + ".provider", localFile);
