...
import com.kevin.parkme.classes.SlotNoInfo;
...
public class AddPositionActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    AppCompatEditText areaNameText,accountNoText,sortNumText,amount2Text,amount3Text,amount4Text,totalSlotsText;
    Button loadFromFile;
    ...
    private void attachListeners() {
        ...
        addLocationBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                String sortNum = sortNumText.getText().toString();
                ...
                if(globalLatLng==null){
                ...
                }else if(areaName.equals("") || accountNo.equals("") || sortNum.equals("") || amount4.equals("") || totalSlots.equals("")){
                    Toast.makeText(AddPositionActivity.this, "Please enter all fields!", Toast.LENGTH_SHORT).show();
                }else if(!utils.isAccountNumValid(accountNo)){
                    Toast.makeText(AddPositionActivity.this, "Invalid Account Number!", Toast.LENGTH_SHORT).show();
                    ...
                    final ParkingArea parkingArea = new ParkingArea(areaName,globalLatLng.latitude,globalLatLng.longitude,
                            auth.getCurrentUser().getUid(),Integer.parseInt(totalSlots),0,Integer.parseInt(amount4),slotNos);
                    final OwnerAccountInfo ownerAccountInfo=new OwnerAccountInfo(accountNo,sortNum);
                    ...
                    db.getReference("ParkingAreas")
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                db.getReference("OwnerAccountInfo")
                                        .child(auth.getCurrentUser().getUid())
                                        .setValue(ownerAccountInfo).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(AddPositionActivity.this, "Failed to add account details", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            } else {
