...
import com.kevin.parkme.OwnerUser.AreaHistoryActivity;
...
import com.kevin.parkme.utils.gps.GpsUtils;
...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sh = getSharedPreferences("ShowIntro", MODE_PRIVATE);
